use hotham::{
    ...
    ash,
    contexts::{
        render_context::{create_shader, Shaders},
        VulkanContext,
    },
...
impl CustomRenderContext {
    pub fn new(engine: &mut Engine) -> Self {
        ...
        render_context
            .shaders
            .insert("quadric.vert.spv".into(), QUADRIC_VERT.into());
        render_context
            .shaders
            .insert("quadric.frag.spv".into(), QUADRIC_FRAG.into());
