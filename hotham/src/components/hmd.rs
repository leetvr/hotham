...
/// engine with the position of the player's headset in the real world (ie. stage space). Since this entity is
/// parented to the [`super::Stage`] entity, querying for the HMD's [`super::GlobalTransform`] will then give
/// the position of the HMD in the virtual world (ie. global space).
///
